...
CORP_API_TYPE = { 
        ...
        'MEDIA_UPLOAD'     : ['/cgi-bin/media/upload?access_token=ACCESS_TOKEN', 'POST'], # 新增
...
class CorpApi(AbstractApi) :
    ...
    # def __mediaUpload(self, filePath):
    #     response = self.httpCall(CORP_API_TYPE['MEDIA_UPLOAD'],{"uploadFile":"yzm.png"})
